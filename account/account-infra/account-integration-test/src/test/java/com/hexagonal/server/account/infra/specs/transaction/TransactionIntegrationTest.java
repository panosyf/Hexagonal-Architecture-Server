package com.hexagonal.server.account.infra.specs.transaction;
...
import static com.hexagonal.server.account.core.domain.enums.TransactionStatusEnum.COMPLETED;
import static com.hexagonal.server.account.infra.common.mocks.TransactionUpdateRequestMocks.generateTransactionUpdateRequest;
