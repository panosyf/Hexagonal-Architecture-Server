package com.hexagonal.server.transaction.infra.persistence.beans.adapters.transaction;

import com.hexagonal.server.transaction.core.domain.service.driven.TransactionRepositoryPort;
import com.hexagonal.server.transaction.infra.persistence.adapters.transaction.TransactionJpaRepository;
import com.hexagonal.server.transaction.infra.persistence.adapters.transaction.TransactionRepositoryAdapter;
